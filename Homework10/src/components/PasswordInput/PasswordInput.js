...
const Eye = (props) => (
    <span>
        <svg {...props} xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 640 512">
...
const EyeSlash = (props) => (
    <span>
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 640 512">
